...
"""
__project_ = 'python'
__file_name__ = 'spider_weibo'
__author__ = 'admin'
__time__ = '2020-03-24 21:00'
...
# reponses = json.loads(reponse.text)
# num = 0
# for json in reponses['data']['statuses']:
#     comment_ID = json['id']
#     num += 1
#     print(comment_ID)
# print(num)
...
def get_title_id():
    for page in range(1, 21):  # 每个页面大约有18个话题
        headers = {
            "User-Agent": random.choice(user_agent_list)  # chrome浏览器随机代理
        }
        time.sleep(1)
        # 该链接通过抓包获得
